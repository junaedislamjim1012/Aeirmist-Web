...
import { 
    ...
    MoreVertical, Move, Pin, X, Info, Maximize2, Trash2, ArrowLeft, ShieldCheck
} from 'lucide-react';
                    ...
                    <div className="max-w-3xl mx-auto space-y-6">
                        ...
                        <div className="flex justify-between items-center bg-white/[0.03] backdrop-blur-2xl border border-white/10 rounded-[30px] p-2 md:p-3 px-6 md:px-8">
                            {[
                                ...
                                >
                                    <btn.icon size={20} />
                                    <span className="text-[9px] font-black uppercase tracking-widest hidden md:block">{btn.label}</span>
                                </button>
                            ))}
                        </div>
                    </div>
